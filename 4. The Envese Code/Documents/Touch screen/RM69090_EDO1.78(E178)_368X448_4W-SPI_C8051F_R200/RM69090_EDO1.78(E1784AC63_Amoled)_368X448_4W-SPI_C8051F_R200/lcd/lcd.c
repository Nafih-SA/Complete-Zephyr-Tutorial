...
WriteComm(0x04);WriteData(0xA0);
WriteComm(0x70);WriteData(0x55);

WriteComm(0xFE);WriteData(0x0A);
WriteComm(0x29);WriteData(0x10);

WriteComm(0xFE);WriteData(0x05);
WriteComm(0x05);WriteData(0x00);

WriteComm(0xFE);WriteData(0x00);
WriteComm(0x51);WriteData(0xaf);
WriteComm(0x53);WriteData(0x10);
	
WriteComm(0x53);WriteData(0x20);
WriteComm(0x35);WriteData(0x00);
WriteComm(0x3A);WriteData(0x55);//RGB565

WriteComm(0x2A);WriteData(0x00);WriteData(0x10);WriteData(0x01);WriteData(0x7F);
WriteComm(0x2B);WriteData(0x00);WriteData(0x00);WriteData(0x01);WriteData(0xBF);
